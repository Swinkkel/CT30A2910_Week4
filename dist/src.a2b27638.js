...
function _fetchData() {
  _fetchData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(show) {
    var url, showsPromise, showsJSON;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return fetch(url);
        case 3:
          showsPromise = _context.sent;
          _context.next = 6;
          return showsPromise.json();
        case 6:
          showsJSON = _context.sent;
